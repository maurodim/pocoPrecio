...
public class ImprimirComprobantes {
    ...
    public void ImprimirPresupuesto(Integer idCotizacion, Integer tipo){
        ...
        while(it.hasNext()){
            ...
            listaArticulos.add(new FormatoArticulos(String.valueOf(detalleDeCotizacion.getIdArticulo()), descripcionArt, String.valueOf(detalleDeCotizacion.getCantidad()), unitario));
    ...
    public void ImprimirTicketFiscal(String razonSocialVendedor,String nombreVendedor, String cVendedor, String cIva, String direccionVendedor, String telefonoVendedor, String iBrutos, String incioActividades){
        ...
        while(it.hasNext()){
            ...
            listaArticulos.add(new FormatoArticulos(String.valueOf(saldo.getIdArticulo()), descripcionArt,String.valueOf(saldo.getCantidad()) , totUni));
